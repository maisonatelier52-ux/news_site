...
// ──────────────────────────────────────────────
const DailyNews = dynamic(() => import("../components/DailyNews"), { loading: () => <div /> });
const CrimeNews = dynamic(() => import("../components/CrimeNews"), { loading: () => <div /> });
const PoliticsNews = dynamic(() => import("../components/PoliticsNews"), { loading: () => <div /> });
const CourtNews = dynamic(() => import("../components/CourtNews"), { loading: () => <div /> });
const InvestigationNews = dynamic(() => import("../components/InvestigationNews"), { loading: () => <div /> });
const CategoryCards = dynamic(() => import("../components/Categorycards"), { loading: () => <div /> });
const CivilrightsNews = dynamic(() => import("../components/CivilrightsNews"), { loading: () => <div /> });
const LawandJusticeNews = dynamic(() => import("../components/LawandjusticeNews"), { loading: () => <div /> });
const UsNews = dynamic(() => import("../components/UsNews"), { loading: () => <div /> });
...
const MainSection = async ({ searchParams }) => {
  ...
  const investigationPost = uniqueInvestigationPosts[0];
  const row2Posts = uniqueInvestigationPosts.slice(1, 3);
  ...
  const lawFirstPost = uniqueLawAndJusticePosts[0];
  const lawSecondPost = uniqueLawAndJusticePosts[1];
  const lawThirdPost = uniqueLawAndJusticePosts[2];
  ...
  return (
    <main>
      ...
      {/* FIRST SECTION - Daily News (CRITICAL PATH) */}
      <DailyNews heroPost={heroPost} smallPosts={smallPosts} />
      ...
      <div className="bg-gradient-to-b from-[#1b1446] via-[#0e0a2b] to-[#07051c] py-[25px] px-0 text-white">
        <InvestigationNews
          heroPost={heroPost}
          smallPosts={smallPosts}
          investiagtionPost={investigationPost}
          row2Posts={row2Posts}
        />
        <CategoryCards 
